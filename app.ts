...
function FindLengthOfSring(str:string){
...
function ConcatTwoStr(str1:string, str2:string) {
...
function CompareTwoStr(str1:string, str2:string){
    if(str1 === str2){
...
function ConvrtLowerStrToUpper(str:string){
...
function ConvrtUpperStrToLower(str:string){
...
function CountAlphaDigitChar(str:string){
    str.split(" ");
    var alphaCounter:number = 0;
    var digitCounter:number = 0;
    var specialCharCounter:number = 0;
...
function CountVowelsConstants(str:string){
    str.split(" ");
    var vowelCounter:number = 0;
    var constantCounter:number = 0;
...
function CountTotalWords(str:string){
    var spaceBreak = str.split(" ")
    var lengthOfWords = spaceBreak.filter(word => word !== '').length
...
function reverseOfString(str:string) {
    let newString = "";
...
const result = reverseOfString("my name");
console.log(result);
...
const value = checkPalindrome("abcdcba");
console.log(value);


// 13. Write a ts program to reverse order of words in a given string
function ReverseOrderOfWords(str:string){
    var rb = str.split(" ")
    var filterjustWord = rb.filter(word => word !== '')
...
function FindFirstOccuranceOfChar(str:string){  
...
function LastOccuranceOfChar(str:string){  
...
var FindHighestFreq = function (str:string) {
    var max = 0,
        maxChar = '';
...
let FindEachFrequency =   function (str:string) {
    return str.split('').reduce((total, letter) => {
      total[letter] ? total[letter]++ : total[letter] = 1;
      return total;
    }, {});
...
function FindLastOccuranceWord(str1:string, str2:string){
    var BSpace = str1.split(" ")
...
function FindAllOccuranceWord(str1:string, str2:string){
    var BSpace = str1.split(" ")
    for(var i = 0; i >= 0; i++){
        if(BSpace[i] == str2){
...
function FindOccuranceOfWord(str1:string, str2:string){
    var BSpace = str1.split(" ")
    var OccuranceCounter:number = 0;
    for(var i = 0; i < BSpace.length; i++){
        if(BSpace[i] == str2){
...
function remove_first_occurrence_word(str:string, searchstr:string){
	var index = str.indexOf(searchstr);
	if (index === -1) {
		return str;
	}
...
function remove_last_occurrence_word(str:string, searchstr:string){
	var index = str.lastIndexOf(searchstr);
	if (index === -1) {
		return str;
	}
...
function remove_All_occurrence_word(str:string, removestr:string){
    var splitstr = str.split(" ")
    var filterStr = splitstr.filter( (word)=> {
...
function removeExtraBlanckSpaces(str:string){
    var RemoveExtraBlank = str.split(" ")
    var filterExtraBlank = RemoveExtraBlank.filter( (removeBlank)=> {
       return removeBlank !== ""
    } )
...
function FindMax(num1:number, num2:number){
    if(num1 > num2){
        var max = `Max Number is nummber ${num1}`
        return max
    } else {
        var max = `Max Number is nummber ${num2}`
        return max
    }
}
...
function FindMaxBtwThree(num1:number, num2:number, num3:number){
    if(num1 > num2 && num1 > num3){
        ...
        var max = `Max Number is nummber ${num3}`
        return max
    }
}
...
function CheckNumEvnOdd(num:number){
    if(num % 2 == 0){
...
function QuadraticEquation(num1:number, num2:number, num3:number){
    var a = num1
    var b = num2
    var c = num3

    var root1:number, root2:number, imaginary:number;
...
function Calculater(num1:number, num2:number, oprtr:string){
    let result:number;
